...
export class BuscadorAdminService {
  ...
  private configuraciones: ResultadoBusqueda[] = [
    ...
    },
    {
      ...
      queryParams: { tab: 'negocio' },
      fragment: 'direccion',
      keywords: ['direccion', 'calle', 'ciudad', 'estado', 'codigo postal', 'cp', 'ubicacion', 'oficina'],
    },
    {
      id: 'c-neg-rfc',
      categoria: 'config',
    ...
    // ============ CONTACTO ============
    {
      ...
      subtitulo: 'Números y emails públicos del negocio',
      icono: '📞',
      ruta: '/admin/configuracion',
      queryParams: { tab: 'contacto' },
      fragment: 'info-contacto',
      keywords: ['telefono', 'whatsapp', 'celular', 'wa', 'numero', 'llamada', 'correo', 'email', 'mail', 'contacto'],
    },
    {
      id: 'c-con-redes',
      categoria: 'config',
      ...
      keywords: ['redes sociales', 'facebook', 'instagram', 'linkedin', 'twitter', 'tiktok', 'youtube', 'social media'],
    },
    ...
    // ============ AGENDA ============
    {
      ...
      keywords: ['horario', 'horas', 'dias laborales', 'lunes', 'martes', 'disponibilidad', 'abierto', 'apertura', 'cierre'],
    },
    {
      id: 'c-ag-duracion',
      categoria: 'config',
    ...
    },
    {
      ...
      queryParams: { tab: 'apariencia' },
      fragment: 'colores',
      keywords: ['colores', 'color primario', 'secundario', 'degradado', 'gradiente', 'paleta', 'tema'],
    },
    {
      id: 'c-ap-preview',
      categoria: 'config',
    ...
    },
    {
      ...
      subtitulo: 'Avisos automáticos por email o WhatsApp antes de las citas',
      icono: '⏰',
      ruta: '/admin/configuracion',
      queryParams: { tab: 'notificaciones' },
      fragment: 'notif-clientes',
      keywords: ['recordatorio', 'aviso cliente', '24 horas', '1 hora', 'canal', 'email', 'whatsapp', 'envio'],
    },
    ...
    // ============ SEO ============
    {
      ...
      queryParams: { tab: 'seo' },
      fragment: 'seo-meta',
      keywords: ['seo', 'meta', 'titulo', 'descripcion', 'google', 'posicionamiento', 'buscadores', 'keywords', 'palabras clave'],
    },
    {
      id: 'c-seo-preview',
      categoria: 'config',
    ...
    // ============ MANTENIMIENTO ============
    {
      ...
      subtitulo: 'Cerrar el sitio temporalmente y mensaje para visitantes',
      icono: '🚧',
      ruta: '/admin/configuracion',
      queryParams: { tab: 'mantenimiento' },
      fragment: 'modo-mantenimiento',
      keywords: ['mantenimiento', 'cerrar sitio', 'offline', 'fuera de servicio', 'pausar', 'desactivar sitio', 'mensaje mantenimiento', 'fecha regreso'],
    },
  ];
